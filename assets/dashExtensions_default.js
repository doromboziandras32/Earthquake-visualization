window.dashExtensions = Object.assign({}, window.dashExtensions, {
    default: {
        ...
        function6: function(feature, latlng, index, context) {
            const {
                min,
                max,
                colorscale,
        ...
        function10: function(feature, latlng, index, context) {
            const {
                min,
                max,
                colorscale,
        ...
        function12: function(feature, latlng) {
            const antenna = L.icon({
                iconUrl: `/static/multiple_antenna.png`,
                iconSize: [24, 24]
            });
            return L.marker(latlng, {
                icon: antenna
        ...
        function15: function(feature, latlng, index, context) {
            const {
                min,
                max,
                colorscale,
